...
exports.getAbilityImage = exports.ABILITY_IMAGE = void 0;
/*
Generate using
...
exports.ABILITY_IMAGE = {
    ...
    CONSCRIPT: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_conscript.png',
    ...
    FURY: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_fury.png',
    ...
    MARTYR: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_martyr.png',
    ...
    REBIRTH: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_rebirth.png',
    ...
    REFLECTION_SHIELD: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_reflection-shield.png',
    ...
    WEAPONS_TRAINING: 'https://d36mxiodymuqjm.cloudfront.net/website/abilities/ability_weapons-training.png',
};
function getAbilityImage(abilityName) {
    var ability = abilityName.split(' ').join('_').toUpperCase();
    // @ts-ignore
    return exports.ABILITY_IMAGE[ability] || '';
}
